...
public class dn {
	...
	private JLabel labelP1,labelP2,labelP3,labelP4,labelP5,labelf1,labelf2,labelf3,labelf4,labelf5,table;
	private JLabel labelth1,labelth2,labelth3,labelth4,labelth5;
	private ImageIcon p1,f1,th1,tbl;
	...
	private void initialize() {
		...
		java.net.URL imageURL3 = getClass().getResource("images/table.jpg");
		tbl = new ImageIcon(imageURL3);
		//System.out.println(imageURL2);
		
		table = new JLabel(tbl,JLabel.CENTER);
		table.setBounds(500,200,500,500);
