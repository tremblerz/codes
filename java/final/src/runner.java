...
public class runner {
	...
	//		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		/*	processSimulation.addActionListener(new ActionListener() {
			...
			welcome.setText("Enjoy the Simulator");
		...
		/*	Cfcfs.setVisible(true);
			...
			npro.setText("Enter number of Processes");
			...
			range.setText("Enter range of the burst time");
	...
	public void simulate(int nOfProcess,int brange){
		...
		RandomInputGeneration1 r = new RandomInputGeneration1(nOfProcess,brange);
		r.randomGeneration();
		if(show[0]){
			fcfs = new JProgressBar();
			fThread = new fcfs1(frame,r,fcfs);
			fThread.start();
		}
		if(show[2]){
